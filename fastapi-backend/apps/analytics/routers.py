...
async def get_analytics(
    ...
    try:
        ...
        return await AnalyticsService.get_overall_analytics(db)
...
async def get_candidate_analytics(
    ...
    try:
        return await AnalyticsService.get_candidate_analytics(db)
    except HTTPException:
        raise
    except Exception as e:
...
async def get_certificate_analytics(
    ...
    try:
        return await AnalyticsService.get_certificate_analytics(db)
    except HTTPException:
        raise
    except Exception as e:
...
async def get_dashboard_overview(
    ...
    try:
        return await AnalyticsService.get_consolidated_overview(db)
    except HTTPException:
        raise
    except Exception as e:
