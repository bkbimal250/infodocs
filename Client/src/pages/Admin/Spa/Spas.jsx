    ...
    let filtered = allSpas.filter((spa) => {
      ...
      if (filter.search) {
        ...
        return (
          ...
          spa.code?.toLowerCase().includes(searchLower) ||
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading SPAs...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">SPA Management</h1>
            <p className="text-gray-600">Manage SPA locations and their details</p>
          </div>
          <button
            onClick={handleAdd}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500 hover:shadow-lg transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 uppercase tracking-wide">Total SPAs</p>
                <p className="text-3xl font-bold text-gray-900 mt-2">{spas.length}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 uppercase tracking-wide">Active SPAs</p>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-gray-400 hover:shadow-lg transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 uppercase tracking-wide">Inactive SPAs</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-end">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-2 text-sm text-gray-700">Show active SPAs only</span>
              </label>
            </div>
          </div>
        </div>
