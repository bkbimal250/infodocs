 ...
 * Modal form to edit candidate form submission
 */
const EditCandidates = ({ candidate, isOpen, onSuccess, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await adminApi.forms.updateCandidateForm(candidate.id, updateData);
