        ...
        <div className="mb-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm hover:shadow-md"
            />
          </div>
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-5 flex items-center justify-between">
                <div className="flex-1">
                  ...
                  {selectedTutorial.description && (
                    <p className="text-blue-100 text-sm line-clamp-2">{selectedTutorial.description}</p>
                  )}
                </div>
                <button
              ...
              <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
                ...
                {(() => {
                  const videoUrl = getVideoUrl(selectedTutorial);
                  if (!videoUrl) {
                    return (
