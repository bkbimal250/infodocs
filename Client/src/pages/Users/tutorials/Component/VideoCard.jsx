...
/**
 * Video Card Component for Users
...
const VideoCard = ({ tutorial, onView }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-200 group">
      {/* Thumbnail Section */}
      <div 
        className="relative w-full h-56 bg-gradient-to-br from-blue-100 to-indigo-100 overflow-hidden cursor-pointer" 
      ...
      >
        {tutorial.thumbnail_url ? (
          <>
            ...
            />
            <div className="hidden absolute inset-0 bg-gradient-to-br from-blue-100 to-indigo-100 items-center justify-center">
              <HiPlay className="w-20 h-20 text-blue-400" />
            </div>
          </>
        ) : (
        ...
        {videoUrl && (
          <div className="absolute inset-0 bg-gradient-to-t from-blue-900/60 via-blue-900/0 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <div className="bg-white rounded-full p-5 transform scale-90 group-hover:scale-100 transition-transform duration-300 shadow-2xl">
              <HiPlay className="w-10 h-10 text-blue-600" />
            </div>
          </div>
        )}
      </div>
        ...
        <div className="flex gap-2">
          {videoUrl && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
