      ...
      <div className="mb-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-[var(--color-border-primary)] rounded-lg focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent"
          />
          {filters.search && (
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-[var(--color-border-primary)] rounded-lg focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent"
            >
          ...
          {/* SPA Filter */}
          <div>
            <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">SPA Location</label>
            <select
              value={filters.spa}
          ...
          {/* Experience Filter */}
          <div>
            <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">Experience</label>
            <select
      ...
      {hasActiveFilters && (
        <div className="mt-4 pt-4 border-t border-gray-200">
          <div className="flex flex-wrap gap-2">
            <span className="text-sm font-medium text-[var(--color-text-primary)]">Active Filters:</span>
            {filters.search && (
