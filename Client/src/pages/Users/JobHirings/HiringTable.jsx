 ...
 * Display user's submitted hiring forms in a table format
 */
          ...
          <tbody className="bg-[var(--color-bg-primary)] divide-y divide-gray-200">
            {hiringForms.map((form) => (
              <tr key={form.id} className="hover:bg-[var(--color-bg-secondary)]">
                ...
                <td className="px-6 py-4">
                  <div className="text-sm text-[var(--color-text-secondary)] max-w-xs truncate" title={form.required_skills}>
