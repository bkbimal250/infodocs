            ...
            <div className="flex items-center justify-between">
              ...
              {!editing && (
                <button
                  ...
                  className="px-4 py-2 bg-[var(--color-bg-primary)] text-[var(--color-primary)] rounded-lg hover:bg-blue-50 font-medium transition-colors"
                >
                  Edit Profile
                </button>
              )}
