...
const Candidatespage = () => {
  ...
  const loadCandidates = async () => {
    try {
      setLoading(true);
      const response = await hrApi.getCandidateForms({ skip: 0, limit: 1000 });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await hrApi.deleteCandidateForm(id);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg shadow-xl p-8">
            <h1 className="text-4xl font-bold mb-3">Candidate Forms</h1>
            <p className="text-blue-100 text-lg">
              View and manage all candidate application submissions
            </p>
          </div>
        </div>
