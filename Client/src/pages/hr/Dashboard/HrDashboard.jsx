    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Overview of candidates, hiring, and certificates</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-900">Recent Hiring Requirements</h2>
              <Link
                to="/hr/hiring-data"
                className="text-sm text-blue-600 hover:text-blue-800 font-medium"
              >
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="font-semibold text-gray-900 mb-1">View Candidates</div>
            ...
            >
              ...
              <div className="font-semibold text-gray-900 mb-1">Hiring Requirements</div>
              <div className="text-sm text-gray-600">View requirements from users/managers</div>
            </Link>
            <Link
              to="/hr/certificates"
            ...
            >
              ...
              <div className="font-semibold text-gray-900 mb-1">Certificates</div>
              <div className="text-sm text-gray-600">View generated certificates</div>
            </Link>
          </div>
        </div>
      </div>
