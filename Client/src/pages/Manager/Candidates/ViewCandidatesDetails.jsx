...
/**
 * Manager Candidate View Details Component
 * Display detailed information about a candidate form submission (only own submitted data)
 */
const ViewCandidatesDetails = () => {
  ...
  const loadCandidateDetails = async () => {
    try {
      setLoading(true);
      const response = await managerApi.getCandidateForm(id);
