 ...
 * Modal form to edit hiring form submission (Manager version)
 */
const EditData = ({ hiringForm, isOpen, onSuccess, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await managerApi.updateHiringForm(hiringForm.id, updateData);
      setSuccess('Hiring form updated successfully!');
      toast.success('Hiring form updated successfully!');
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div
          className="relative bg-white rounded-lg shadow-2xl max-w-3xl w-full p-6 transform transition-all border-2 border-gray-200"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900">Edit Hiring Form</h2>
            <button
              onClick={onCancel}
