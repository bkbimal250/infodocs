...
const Tutorials = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-emerald-50/30 to-teal-50/30 py-8 px-4">
        ...
        <div className="mb-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all shadow-sm hover:shadow-md"
            />
          </div>
        </div>
              ...
              <div className="bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-5 flex items-center justify-between">
                <div className="flex-1">
                  ...
                  {selectedTutorial.description && (
                    <p className="text-emerald-100 text-sm line-clamp-2">{selectedTutorial.description}</p>
                  )}
                </div>
                <button
